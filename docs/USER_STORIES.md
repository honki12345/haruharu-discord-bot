...
- 결과표에 사용자별 오늘 상태, 기상시간, `latecount`, `absencecount`, 잔여휴가를 함께 표시
...
sequenceDiagram
    ...
    Note over T: ### 2025-12-08 출석표<br/>- 홍길동: 출석 (기상시간 06:00, 지각 0회, 결석 0회, 잔여휴가 5일)<br/>- 김아침: 출석 (기상시간 07:00, 지각 1회, 결석 0회, 잔여휴가 5일)<br/>- 이영희: 지각 (기상시간 07:30, 지각 3회, 결석 1회, 잔여휴가 5일)<br/>- 박민수: 휴가 (기상시간 08:00, 지각 0회, 결석 0회, 잔여휴가 4일)<br/>- 최민지: 결석 (기상시간 06:30, 지각 0회, 결석 2회, 잔여휴가 5일)
```
